                                ...
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 mt-1">
                                             {{ howLongAgo($notification->data['time']) }}
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="user-dropdown"
                    ...
                    <div class="p-2">
                        ...
                        <form action="{{ route('logout') }}" method="POST"
                            class="flex items-center space-x-2 px-4 py-2 text-sm text-red-600 hover:bg-red-50 rounded-lg">
                            @csrf
