...
@section('content')
<form method="POST" action="{{ @$project->id ? route('admin.projects.update', $project->id) : route('admin.projects.store') }}"
    enctype="multipart/form-data">
    <div class="flex justify-between items-center ">
        <h2 class="text-3xl pt-6 px-5 font-bold text-gray-800 mb-2">
            {{ @$album->id ? 'Edit' : 'Add' }} Project
        </h2>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="title" name="title" type="text"
                                ...
                                required class="w-full px-4 py-2 bg-white border @error('title') border-red-500 @else border-gray-300 @enderror
                        ...
                        <div>
                            <label for="category_id" class="block mb-2 text-base font-medium text-gray-700">Category</label>
                            <select name="category_id" id="category_id"
                                class="w-full px-4 py-2 bg-white border @error('category_id') border-red-500 @else border-gray-300 @enderror
                                rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                        ...
                        <div>
                            ...
                            <input name="tags" id="tags"
                                ...
                                class="w-full px-4 py-2 bg-white border @error('tags') border-red-500 @else border-gray-300 @enderror
                                rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition">
                            @error('tags')
                                <span class="text-red-600 text-sm mt-1">{{ $message }}</span>
                            @enderror
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div class="mb-4">
                                    <div class="flex items-center mt-2">
                                        ...
                                        <label for="is_featured" class="ml-2 text-base font-medium text-gray-700">Is Featured</label>
                                    </div>
                                    @error('is_featured')
                                        <span class="text-red-600 text-sm mt-1">{{ $message }}</span>
                                    @enderror
                ...
                <div class="lg:col-span-4 rounded-xl">
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div id="image-preview-container"
                            ...
                            <img id="preview" src="{{ supaUrl($project->image) }}" alt="Current Image"
