...
<form method="POST" action="{{ @$slide->id ? route('admin.slides.update', $slide->id) : route('admin.slides.store') }}"
    enctype="multipart/form-data">
    <div class="flex justify-between items-center ">
        <h2 class="text-3xl pt-6 px-5 font-bold text-gray-800 mb-2">
            {{ @$album->id ? 'Edit' : 'Add' }} Slide
        </h2>
            ...
            <div class="grid grid-cols-1 mt-6">
                <div class="lg:col-span-8 bg-white ">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label for="name" class="block mb-2 text-base font-medium text-gray-700">Caption</label>
                            <input id="name" name="caption" type="text" value="{{ old('caption', @$slide->caption) }}" required
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input id="serial" name="serial" type="number"
                                    value="{{ old('serial', @$slide->serial ?? 1) }}"
                            ...
                            <div>
                                ...
                                <select id="status" name="status"
                                    ...
                                    <option value="1" {{ old('status', @$slide->status) != '0' ? 'selected' : ''
                                        }}>Active</option>
